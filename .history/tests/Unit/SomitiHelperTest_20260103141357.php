...
class SomitiHelperTest extends TestCase
{
    ...
    public function test_set_active_financial_year()
    {
        ...
        $fy1 = FinancialYear::factory()->create(['somiti_id' => $somiti->id, 'is_active' => false, 'title' => 'FY 2025']);
        $fy2 = FinancialYear::factory()->create(['somiti_id' => $somiti->id, 'is_active' => false, 'title' => 'FY 2026']);
