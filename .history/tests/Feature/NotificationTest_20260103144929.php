...
class NotificationTest extends TestCase
{
    ...
    public function test_user_can_list_personal_and_somiti_notifications()
    {
        ...
        Notification::create(['somiti_id' => $somiti2->id, 'user_id' => $user->id, 'title' => 'Hello', 'message' => 'personal', 'is_read' => false]);
    ...
    public function test_user_cannot_view_other_users_notification()
    {
        ...
        $notification = Notification::create(['somiti_id' => Somiti::factory()->create(['created_by_user_id' => $other->id])->id, 'user_id' => $other->id, 'title' => 'Hi', 'message' => 'private']);
    ...
    {
        $user = User::factory()->create();
        $notification = Notification::create(['somiti_id' => Somiti::factory()->create(['created_by_user_id' => $user->id])->id, 'user_id' => $user->id, 'title' => 'Temp', 'message' => 'delete']);
