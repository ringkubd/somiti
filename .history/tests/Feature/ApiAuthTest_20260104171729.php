...
class ApiAuthTest extends TestCase
{
    ...
    {
        $user = User::factory()->create(['phone' => '01700000002', 'password' => \Illuminate\Support\Facades\Hash::make('password')]);
    ...
    {
        $user = User::factory()->create(['phone' => '01700000003', 'password' => \Illuminate\Support\Facades\Hash::make('password')]);
    ...
    {
        $user = User::factory()->create(['phone' => '01700000004', 'password' => \Illuminate\Support\Facades\Hash::make('password')]);
