...
class User extends Authenticatable
{
    ...
    public function ownedSomitis(): \Illuminate\Database\Eloquent\Relations\HasMany
    {
        return $this->hasMany(Somiti::class, 'created_by_user_id');
    }
    ...
    // Permissions (simple table-based permissions)
