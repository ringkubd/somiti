...
class UserTest extends TestCase
{
    ...
    public function test_pending_approvals_scope()
    {
        ...
        // create minimal approvals (attach to a placeholder approvable)
        $user->approvals()->create(['approvable_type' => \App\Models\Deposit::class, 'approvable_id' => 0, 'status' => 'pending']);
        $user->approvals()->create(['approvable_type' => \App\Models\Deposit::class, 'approvable_id' => 1, 'status' => 'approved']);
