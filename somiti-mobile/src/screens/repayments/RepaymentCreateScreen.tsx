...
export default function RepaymentCreateScreen({ route, navigation }: any) {
    ...
    const submit = async () => {
        ...
        setSubmitting(true);
        try {
            await client.post(`/loans/${loanId}/repayments`, {
    ...
    return (
        <ScrollView style={styles.container} contentContainerStyle={styles.content}>
            ...
            <Text style={styles.hint}>Pay against loan #{loanId}. Your payment needs manager approval.</Text>
            <TextInput style={styles.input} placeholder="Amount" value={amount} onChangeText={setAmount} keyboardType="decimal-pad" />
            <TextInput style={styles.input} placeholder="Payment date (YYYY-MM-DD)" value={paymentDate} onChangeText={setPaymentDate} autoCapitalize="none" />
